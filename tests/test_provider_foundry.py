...
@pytest.mark.asyncio
async def test_send_message_derives_foundry_base_url_from_resource() -> None:
...
@pytest.mark.asyncio
async def test_send_message_uses_entra_id_token_when_no_api_key() -> None:
...
@pytest.mark.asyncio
async def test_send_message_with_tools_uses_entra_id_token_when_no_api_key() -> None:
    seen: dict[str, str | None] = {"api_key": None}
