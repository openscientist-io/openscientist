...
_PROVIDER_CLASS_PATHS: dict[str, tuple[str, str]] = {
    ...
    "llamacpp": ("openscientist.providers.llamacpp", "LlamaCppProvider"),
    "bedrock-openai": ("openscientist.providers.bedrock_openai", "BedrockOpenAIProvider"),
}
...
def get_provider() -> Provider:
    ...
    Returns:
        ...
        ClaudeCompatible, OpenAI/Azure-OpenAI/Ollama/Bedrock-OpenAI are
        CodexCompatible, and vLLM and llama.cpp are self-hosted
        OpenAiWireCompatible (omp only, not Codex backends).
    ...
    Environment:
        OPENSCIENTIST_PROVIDER: Provider name ("anthropic", "cborg", "vertex",
                               ...
                               "ollama", "vllm", "llamacpp", "bedrock-openai").
                               Required: an unset value raises at startup.
    """
