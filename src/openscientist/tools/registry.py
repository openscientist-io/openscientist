...
def build_tool_list(
    ...
    from openscientist.tools.job_meta import make_tools as meta_tools
    from openscientist.tools.knowledge import make_tools as knowledge_tools
    from openscientist.tools.pubmed import make_tools as pubmed_tools
    ...
    try:
        from openscientist.tools.phenix import make_tools as phenix_tools
