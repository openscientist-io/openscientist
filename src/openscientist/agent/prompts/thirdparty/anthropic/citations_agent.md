...
description: Use for post-hoc citation grounding. Invoke after a research report has been drafted to verify that claims are backed by source material and to insert formally-formatted citations. Returns the report with <exact_text_with_citation> markup.
model: inherit
