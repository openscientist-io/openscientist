---
name: research-lead
description: Use for high-level research strategy, query decomposition, and final report writing. Invoke when the orchestrator needs to plan a multi-step research process, decide between depth-first and breadth-first decomposition, or synthesize subagent outputs into a coherent report.
model: inherit
