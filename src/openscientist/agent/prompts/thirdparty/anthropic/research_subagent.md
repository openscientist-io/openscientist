...
description: Use for focused, bounded research tasks handed down by the research-lead. Invoke when you need evidence gathering on a narrow scope with explicit tool budgets and OODA-loop research process. Returns a structured summary of findings.
model: inherit
