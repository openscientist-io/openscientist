...
from open_scientist.exceptions import PDFGenerationError
...
class ReportPDF(FPDF):
    """Custom PDF class for Open Scientist reports with professional styling."""
    ...
    def header(self) -> None:
        ...
        if self.page_no() > 1:
            ...
            self.cell(
                0,
                10,
                "Open Scientist Scientific Report",
                new_x=XPos.LMARGIN,
                new_y=YPos.NEXT,
                align="R",
            )
    ...
    def add_footer(self) -> None:
        """Add Open Scientist attribution footer."""
        self.ln(10)
        ...
        self.cell(
            0,
            5,
            "Generated by Open Scientist - Scientific Hypothesis Agent for Novel Discovery",
            new_x=XPos.LMARGIN,
            new_y=YPos.NEXT,
            align="C",
        )
...
def markdown_to_pdf(
    ...
    Args:
        ...
        add_footer: Whether to add Open Scientist attribution footer
