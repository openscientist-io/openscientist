...
class ReportPDF(FPDF):
    """Custom PDF class for OpenScientist reports with professional styling."""
    ...
    def header(self) -> None:
        ...
        if self.page_no() > 1:
            ...
            self.cell(
                0,
                10,
                "OpenScientist Scientific Report",
                new_x=XPos.LMARGIN,
                new_y=YPos.NEXT,
                align="R",
            )
    ...
    def add_footer(self) -> None:
        """Add OpenScientist attribution footer."""
        self.ln(10)
...
def markdown_to_pdf(
    ...
    Args:
        ...
        add_footer: Whether to add OpenScientist attribution footer
