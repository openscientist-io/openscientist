...
```
openscientist/                          # Renamed from ad-swarm
...
├── docs/
│   ├── plans/
│   │   └── 2025-11-13-openscientist-autonomous-loop-design.md  # This document
│   └── user_guide.md
│
...
2. ⬜ Set up project structure (`openscientist/` repository)
